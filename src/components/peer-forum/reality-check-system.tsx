...
export function RealityCheckSystem() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(q, (snapshot) => {
      const reviewsList = snapshot.docs.map(
        (doc) =>
          ({
            id: doc.id,
            ...doc.data(),
  ...
  useEffect(() => {
    ...
    if (authorTypeFilter && authorTypeFilter !== "all") {
      filtered = filtered.filter(
        (review) => review.authorType === authorTypeFilter
      );
    }
  ...
  const handleSubmitReview = async () => {
    ...
    if (
      !reviewForm.collegeName.trim() ||
      !reviewForm.courseName.trim() ||
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your review has been posted and will help other students make informed decisions.",
        variant: "default",
      });
        ...
        <CardHeader>
          <div className="flex justify-between items-start">
            <div>
              ...
              <CardDescription>
                Genuine, experience-based reviews of courses and colleges from
            ...
            <Dialog open={showReviewForm} onOpenChange={setShowReviewForm}>
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Share your honest experience to help other students make
                    informed decisions.
                  </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <Select
                        value={reviewForm.authorType}
                        onValueChange={(value: "student" | "alumni") =>
                          setReviewForm({ ...reviewForm, authorType: value })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        type="number"
                        placeholder={
                          reviewForm.authorType === "alumni" ? "2023" : "2"
                        }
                        value={
                          reviewForm.authorType === "alumni"
                            ? reviewForm.graduationYear || ""
                            : reviewForm.currentYear || ""
                        }
                        onChange={(e) => {
                        ...
                        >
                          ...
                          <Select
                            value={reviewForm.categories[
                              category.key as keyof typeof reviewForm.categories
                            ].toString()}
                            onValueChange={(value) =>
                              setReviewForm({
                                ...reviewForm,
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
            ...
            <Select
              ...
              onValueChange={setAuthorTypeFilter}
            >
              <SelectTrigger>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        ...
                        <Badge variant="secondary">
                          {review.authorType === "alumni"
                            ? `Alumni ${review.graduationYear}`
                            : `Year ${review.currentYear}`}
                        </Badge>
                        {review.isVerified && (
                    ...
                    {CATEGORIES.map((category) => (
                      <div key={category.key} className="text-center">
                        <div className="text-sm font-medium">
                          {
                            review.categories[
                              category.key as keyof typeof review.categories
                            ]
                          }
                          /5
                        </div>
                    ...
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        <Button
                          ...
                          className={
                            userInteractions.reviewsHelpful?.includes(review.id)
                              ? "text-green-600"
                              : ""
                          }
                        >
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() =>
                            handleRateHelpfulness(review.id, false)
                          }
                          className={
                            userInteractions.reviewsNotHelpful?.includes(
                              review.id
                            )
                              ? "text-red-600"
                              : ""
