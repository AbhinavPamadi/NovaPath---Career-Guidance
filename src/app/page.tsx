...
// Removed translation imports to minimize API calls
  ...
  return (
    <div className="w-full mx-auto px-4 py-12 sm:py-24 overflow-hidden">
      ...
      <div className="relative">
        ...
        <div
          className="absolute top-[-1rem] -right-24 w-80 h-80 bg-accent rounded-full mix-blend-lighten filter blur-3xl opacity-20 animate-float"
